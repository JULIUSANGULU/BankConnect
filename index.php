      ...
      <nav class="nav">
        ...
        <ul class="nav__links">
          ...
          <li class="nav__item open">
            <a class="open nav__link nav__link--btn btn--show-modal" href="#"
              >Open account</a
            >
          </li>
        </ul>
      ...
      <div class="hero_container">
        ...
        <div class="formContainer">
          <form action="" method="POST">
            <div class="boxInput">
              <span
                class="text-danger d-flex text-center font-weight-light border justify-content-center rounded-pill p-2 mb-2"
              >
                <?php echo "";
              include('errors.php'); ?>
              </span>
